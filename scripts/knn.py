...
for k in x_list:
    ...
    filename = "../heart/knn/" + fileout + "/output.txt"
    ...
    title = "Learning Curve: Heart Disease Data, K Nearest Neighbors - " + fileout
    plt2 = plot_learning_curve(clf, title, trainX, trainY, (0.0, 1.1), cv=5, n_jobs=4, train_sizes=np.linspace(.1, 1.0, 5))

    plt2.savefig("../heart/knn/" + fileout + "/learning_curve.png", bbox_inches='tight')
    plt2.close()
    ...
    plt.savefig("../heart/knn/" + fileout + "/confusion_matrix.png", bbox_inches='tight')
    plt.close()
    out += [newOut]
    print(newOut)

with open("../heart/knn/MASTER.csv", "w") as f:
...
plt.savefig("../heart/knn/MASTER.png", bbox_inches='tight')
...
# plt.savefig("../heart/knn/MASTER.png")
# plt.show()